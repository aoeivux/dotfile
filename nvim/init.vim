...
"
"
" set statusline=%1*\\༼\ \つ\ \◕\‿\◕\ \༽\つ\ξ\▄\︻\┻\┳\═\一\ \ %<%.50F\           "显示文件名和文件路径 
" set statusline+=%=%2*\%y%m%r%h%w\ %*        "显示文件类型及文件状态
" set statusline+=%3*\%{&ff}\[%{&fenc}]\ %*   "显示文件编码类型
" set statusline+=%4*\ row:%l/%LC\ col:%c\ %*   "显示光标所在行和列
" set statusline+=%5*\%3p%%\ \ %*            "显示光标前文本所占总文本的比例
" set statusline+=%6*\[%{File_size(@%)}]\ %*
...
noremap ff :FloatermNew --height=0.8 --width=0.7 <CR>

noremap fr :FloatermNew ranger $(pwd)<CR>
